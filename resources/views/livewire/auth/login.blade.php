<div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
    <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-slate-900 mb-2">Toko Barokah Jaya </h1>
    ...
    <!-- Register Link & Back to Catalog -->
    <div class="mt-6 text-center space-y-3">
        <p class="text-sm text-slate-600">
            Customer?
            <a href="{{ route('catalog') }}" class="text-slate-900 hover:text-slate-700 font-medium">
                Kembali ke Katalog
            </a>
        </p>
        <p class="text-sm text-slate-600">
            Belum punya akun customer?
            <a href="{{ route('register') }}" class="text-slate-900 hover:text-slate-700 font-medium">
                Daftar di sini
            </a>
        </p>
    </div>
